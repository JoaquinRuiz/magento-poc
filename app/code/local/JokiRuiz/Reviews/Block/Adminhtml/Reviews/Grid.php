...
class JokiRuiz_Reviews_Block_Adminhtml_Reviews_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('jokiruiz_reviews_grid');
    ...
    {
        return 'jokiruiz_reviews/review_collection';
    }
    ...
    {
        $helper = Mage::helper('jokiruiz_reviews');
